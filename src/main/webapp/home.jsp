...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            ...
            <button type="button" class="btn btn-success"><a href="/staff?action=singout">SingOut</a></button>
        </div>
    </div>
</nav>
<!-- Masthead-->
...
<table class="container table table-striped">
    ...
    <c:forEach var="p" items="${staffs}">
        <tr>
            ...
            <td>${p.phoneNumber}</td>
            <td>${p.email}</td>
            <td>${p.getDepartment().name}</td>
            <td><button type="button" class="btn btn-warning"><a href="/staff?id=${p.id}&action=edit">edit</a></button></td>
